...
export declare class NgxSmartModalService {
    ...
    private _document;
    private _modalStack;
    constructor(_componentFactoryResolver: ComponentFactoryResolver, _appRef: ApplicationRef, _injector: Injector, _document: any, _modalStack: NgxSmartModalStackService);
    /**
