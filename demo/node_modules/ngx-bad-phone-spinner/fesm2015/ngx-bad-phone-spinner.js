...
import { EventEmitter, Input, Output, Component, forwardRef, Pipe, NgModule } from '@angular/core';
...
NgxBadPhoneSpinnerComponent = NgxBadPhoneSpinnerComponent_1 = __decorate([
    Component({
...
var NgxBadPhoneSpinnerModule_1;
let NgxBadPhoneSpinnerModule = NgxBadPhoneSpinnerModule_1 = class NgxBadPhoneSpinnerModule {
    static forRoot() {
        return {
            ngModule: NgxBadPhoneSpinnerModule_1,
            providers: []
        };
    }
};
NgxBadPhoneSpinnerModule = NgxBadPhoneSpinnerModule_1 = __decorate([
    NgModule({
        declarations: [
            NgxBadPhoneSpinnerComponent,
            RangePipe
